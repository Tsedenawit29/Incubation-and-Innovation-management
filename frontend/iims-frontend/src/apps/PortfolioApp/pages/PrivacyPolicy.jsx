...
function PrivacyPolicy() {
 return (
 <div className="min-h-screen bg-gradient-to-br from-[hashtag#299DFF]/10 to-[hashtag#0A2D5C]/10 py-16 px-4 flex flex-col items-center">
 <h1 className="text-4xl font-extrabold text-[hashtag#0A2D5C] mb-6 text-center drop-shadow-lg">
 Privacy Policy
 </h1>
 <div className="max-w-4xl w-full bg-[hashtag#0A2D5C] text-white rounded-2xl shadow-xl p-8 border-t-8 border-[hashtag#299DFF]">
 ...
 <h2 className="text-xl font-semibold mt-6 mb-2 text-[hashtag#299DFF]">
 ...
 className="text-[hashtag#299DFF] hover:underline"
 >
