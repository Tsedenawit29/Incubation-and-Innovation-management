                              ...
                              <button
                                ...
                                className={`px-3 py-1 rounded-full text-xs font-medium transition-all duration-200 ${
                                  submission.status === 'APPROVED'
                                    ...
                                    : 'bg-white text-green-600 border border-green-300 hover:bg-green-50 hover:shadow-md'
                                }`}
                              >
                              ...
                              <button
                                ...
                                className={`px-3 py-1 rounded-full text-xs font-medium transition-all duration-200 ${
                                  submission.status === 'NEEDS_REVISION'
                                    ...
                                    : 'bg-white text-orange-600 border border-orange-300 hover:bg-orange-50 hover:shadow-md'
                                }`}
                              >
                                {submission.status === 'NEEDS_REVISION' ? '🔄 Needs Revision' : '📝 Needs Revision'}
                              </button>
                              ...
                              <button
                                ...
                                className={`px-3 py-1 rounded-full text-xs font-medium transition-all duration-200 ${
                                  submission.status === 'REJECTED'
                                    ...
                                    : 'bg-white text-red-600 border border-red-300 hover:bg-red-50 hover:shadow-md'
                                }`}
                              >
