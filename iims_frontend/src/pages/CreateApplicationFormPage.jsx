...
export default function CreateApplicationFormPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col items-center py-10 px-4">
      <div className="w-full max-w-4xl bg-white rounded-2xl shadow-xl p-8 relative border-t-8 border-blue-600">
        <button
          className="absolute left-4 top-4 text-blue-600 hover:text-blue-800 text-2xl transition-colors"
          onClick={() => navigate("/application-forms")}
          aria-label="Back"
        >
          ←
        </button>
        <h1 className="text-3xl font-bold text-blue-700 mb-8 text-center">Create Application Form</h1>
        <form onSubmit={handleSubmit}>
          ...
          {/* Cohort & Industry Management Section */}
          <div className="mb-8 p-6 bg-green-50 rounded-xl border border-green-200">
            <h2 className="text-2xl font-bold text-green-800 mb-4">Cohort & Industry</h2>
            
            {/* Cohort Section */}
            <div className="mb-6 border-b border-green-300 pb-4">
              <h3 className="text-xl font-semibold text-green-700 mb-2">Assign Cohort</h3>
              <div className="flex flex-col md:flex-row items-center space-y-2 md:space-y-0 md:space-x-4 mb-2">
                <select
                  className="flex-1 w-full border rounded-xl px-3 py-2 text-green-700 bg-white"
              ...
              <div className="flex flex-col md:flex-row items-center space-y-2 md:space-y-0 md:space-x-2 mt-4">
                <input
                  ...
                  placeholder="Create New Cohort Name"
                  value={newCohortName}
            ...
            {/* Industry Section */}
            <div>
              <h3 className="text-xl font-semibold text-green-700 mb-2">Assign Industry</h3>
              <div className="flex flex-col md:flex-row items-center space-y-2 md:space-y-0 md:space-x-4 mb-2">
                <select
                  className="flex-1 w-full border rounded-xl px-3 py-2 text-green-700 bg-white"
              ...
              <div className="flex flex-col md:flex-row items-center space-y-2 md:space-y-0 md:space-x-2 mt-4">
                <input
                  type="text"
                  className="flex-1 w-full border rounded-xl px-3 py-2 text-green-900 placeholder-green-400"
                  placeholder="Create New Industry Name"
