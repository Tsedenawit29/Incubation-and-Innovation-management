...
export default function RejectAdminModal({ isOpen, onClose, request, onConfirm }) {
      ...
      <div className="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
        <div className="mt-3">
          ...
          <div className="mt-4 text-center">
            <h3 className="text-lg font-medium text-gray-900">Reject Admin Request</h3>
            <div className="mt-2 px-7 py-3">
              <p className="text-sm text-gray-500">
                Are you sure you want to reject <strong>{request.fullName}</strong>'s admin request?
              </p>
